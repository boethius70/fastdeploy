...
$os_config = array(
	         "os_name" => "VMware",
	         "os_vendor" => "VMware",
                   "os_version" => "3", // use a _ instead of . for a "dot-version" delimiter (this is for compatibility with MySQL and class constructor naming conventions
                   "os_subversion" => "ESX",
                   "os_friendly_name" => "VMware ESX Server 3.0.2",
                   "os_mirror" => "http://mirrors.kernel.org/centos/5/os", // a remote Internet based mirror (used instead of local mirror if os_mirror_local is 0
                   "os_mirror_local" => 1, // toggle local or remote installation mirrors (0 = remote, 1 = local)
                   "os_icon" => "vmware_icon.gif", // for small visual display inside the tab container
...
class OS_VMware_3_ESX_Deploy extends HTML_QuickForm { // Note the formatting (strip the "dot" in the version out)              
	var $_viewstate;
	function OS_VMware_3_ESX_Deploy($op) { 
