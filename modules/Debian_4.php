...
$os_config = array(
	         "os_name" => "Debian",
	         "os_vendor" => "Debian",
                   "os_version" => "4", // use a _ instead of . for a "dot-version" delimiter (this is for compatibility with MySQL and class constructor naming conventions
                   "os_subversion" => "",
                   "os_friendly_name" => "Debian 4",   
...
class OS_Debian_4_Deploy extends HTML_QuickForm { // Note the formatting (strip the "dot" in the version out)              
	function OS_Debian_4_Deploy($op) { 
 	...
 	function architecture ($cpu) {
   	...
   	*/
   		$cpu = array("" => "-->Pick a CPU type", // note the architecture's nomenclature here; this is referenced by 
   			   ...
   			   "x64_64" => "AMD Opteron or Athlon64 64-bit", // very important!
