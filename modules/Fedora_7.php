...
$os_config = array(
	         "os_name" => "Fedora",
	         "os_vendor" => "Fedora",
                   "os_version" => "7", // use a _ instead of . for a "dot-version" delimiter (this is for compatibility with MySQL and class constructor naming conventions
                   "os_subversion" => "",
                   "os_friendly_name" => "Fedora Core 7",
                   "os_mirror" => "http://mirrors.kernel.org/fedora/core/7/os", // a remote Internet based mirror (used instead of local mirror if os_mirror_local is 0
...
class OS_Fedora_7_Deploy extends HTML_QuickForm { // Note the formatting (strip the "dot" in the version out)              
	function OS_Fedora_7_Deploy($op) { 
